...
var $author$project$Submissions$NamePage = {$: 'NamePage'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Submissions$init = function (_v0) {
	return _Utils_Tuple2(
		{errorMessage: $elm$core$Maybe$Nothing, gameLevel: '', gameName: '', githubLink: '', jsonOutput: '', notes: '', page: $author$project$Submissions$NamePage, saveStatus: $elm$core$Maybe$Nothing, studentName: ''},
		$elm$core$Platform$Cmd$none);
};
var $author$project$Submissions$FirebaseResult = function (a) {
	return {$: 'FirebaseResult', a: a};
};
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Submissions$firebaseSaveResult = _Platform_incomingPort('firebaseSaveResult', $elm$json$Json$Decode$string);
var $author$project$Submissions$subscriptions = function (_v0) {
	return $author$project$Submissions$firebaseSaveResult($author$project$Submissions$FirebaseResult);
};
var $author$project$Submissions$ConfirmationPage = {$: 'ConfirmationPage'};
var $author$project$Submissions$SaveToFirebase = {$: 'SaveToFirebase'};
var $author$project$Submissions$SavingPage = {$: 'SavingPage'};
var $author$project$Submissions$SubmissionPage = {$: 'SubmissionPage'};
...
var $author$project$Submissions$encodeSubmission = function (model) {
...
var $author$project$Submissions$gameOptionsByLevel = $elm$core$Dict$fromList(
	_List_fromArray(
		[
			_Utils_Tuple2(
			'Beginner',
...
var $author$project$Submissions$getGameOptions = function (level) {
	return A2(
		$elm$core$Maybe$withDefault,
		_List_Nil,
		A2($elm$core$Dict$get, level, $author$project$Submissions$gameOptionsByLevel));
};
...
var $author$project$Submissions$saveToFirebase = _Platform_outgoingPort('saveToFirebase', $elm$core$Basics$identity);
var $elm$core$Process$sleep = _Process_sleep;
var $elm$core$String$trim = _String_trim;
var $author$project$Submissions$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'UpdateName':
				var name = msg.a;
			...
			case 'UpdateGameLevel':
				var level = msg.a;
				var gameOptions = $author$project$Submissions$getGameOptions(level);
				var defaultGame = A2(
					$elm$core$Maybe$withDefault,
					'',
					$elm$core$List$head(gameOptions));
				return _Utils_Tuple2(
					_Utils_update(
						model,
			...
			case 'SubmitName':
				return ($elm$core$String$trim(model.studentName) === '') ? _Utils_Tuple2(
					...
					_Utils_update(
						model,
						{errorMessage: $elm$core$Maybe$Nothing, page: $author$project$Submissions$SubmissionPage}),
					$elm$core$Platform$Cmd$none);
			case 'SubmitForm':
				if (($elm$core$String$trim(model.gameLevel) === '') || (($elm$core$String$trim(model.gameName) === '') || ($elm$core$String$trim(model.githubLink) === ''))) {
					...
					var jsonOutput = A2(
						...
						2,
						$author$project$Submissions$encodeSubmission(model));
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								page: $author$project$Submissions$SavingPage,
								saveStatus: $elm$core$Maybe$Just('Saving your submission...')
							}),
						A2(
							$elm$core$Task$perform,
							function (_v1) {
								return $author$project$Submissions$SaveToFirebase;
							},
			...
			case 'SaveToFirebase':
				return _Utils_Tuple2(
					model,
					$author$project$Submissions$saveToFirebase(
						$author$project$Submissions$encodeSubmission(model)));
			case 'FirebaseResult':
				var result = msg.a;
				return A2($elm$core$String$startsWith, 'Error:', result) ? _Utils_Tuple2(
					_Utils_update(
						model,
						{
							...
							page: $author$project$Submissions$SubmissionPage,
					...
					_Utils_update(
						model,
						{
							page: $author$project$Submissions$ConfirmationPage,
							saveStatus: $elm$core$Maybe$Just('Successfully saved to Firebase')
						}),
					$elm$core$Platform$Cmd$none);
			case 'BackToName':
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{page: $author$project$Submissions$NamePage}),
					$elm$core$Platform$Cmd$none);
			default:
				return $author$project$Submissions$init(_Utils_Tuple0);
		}
	});
...
var $author$project$Submissions$viewError = function (maybeError) {
	if (maybeError.$ === 'Just') {
...
var $author$project$Submissions$Reset = {$: 'Reset'};
...
var $author$project$Submissions$viewConfirmationPage = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('✓ Saved to Firebase')
							]))
					])),
				A2(
				$elm$html$Html$div,
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$text('This data has been saved to your Firebase database.')
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Submissions$Reset),
...
var $author$project$Submissions$SubmitName = {$: 'SubmitName'};
var $author$project$Submissions$UpdateName = function (a) {
...
var $author$project$Submissions$viewNamePage = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Submissions$UpdateName),
				...
				_List_fromArray(
					[
						$elm$html$Html$Events$onClick($author$project$Submissions$SubmitName),
						$elm$html$Html$Attributes$class('w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500')
					]),
				_List_fromArray(
					[
...
var $author$project$Submissions$viewSavingPage = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
...
var $author$project$Submissions$BackToName = {$: 'BackToName'};
var $author$project$Submissions$SubmitForm = {$: 'SubmitForm'};
var $author$project$Submissions$UpdateGameLevel = function (a) {
	return {$: 'UpdateGameLevel', a: a};
};
var $author$project$Submissions$UpdateGameName = function (a) {
	return {$: 'UpdateGameName', a: a};
};
var $author$project$Submissions$UpdateGithubLink = function (a) {
	return {$: 'UpdateGithubLink', a: a};
};
var $author$project$Submissions$UpdateNotes = function (a) {
...
var $author$project$Submissions$viewSubmissionPage = function (model) {
	var gameOptions = $author$project$Submissions$getGameOptions(model.gameLevel);
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
			...
			[
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Submissions$UpdateGameLevel),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Submissions$UpdateGameName),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Submissions$UpdateGithubLink),
					...
					[
						...
						_List_fromArray(
							[
								...
								$elm$html$Html$Events$onInput($author$project$Submissions$UpdateNotes),
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Submissions$BackToName),
						...
						_List_fromArray(
							[
								$elm$html$Html$Events$onClick($author$project$Submissions$SubmitForm),
...
var $author$project$Submissions$viewPage = function (model) {
	var _v0 = model.page;
	switch (_v0.$) {
		case 'NamePage':
			return $author$project$Submissions$viewNamePage(model);
		case 'SubmissionPage':
			return $author$project$Submissions$viewSubmissionPage(model);
		case 'SavingPage':
			return $author$project$Submissions$viewSavingPage(model);
		default:
			return $author$project$Submissions$viewConfirmationPage(model);
	}
};
var $author$project$Submissions$view = function (model) {
	return A2(
		$elm$html$Html$div,
		_List_fromArray(
			[
							...
							[
								...
								_List_fromArray(
									[
										...
										$author$project$Submissions$viewPage(model),
										$author$project$Submissions$viewError(model.errorMessage)
									]))
							]))
					]))
			]));
};
var $author$project$Submissions$main = $elm$browser$Browser$element(
	{init: $author$project$Submissions$init, subscriptions: $author$project$Submissions$subscriptions, update: $author$project$Submissions$update, view: $author$project$Submissions$view});
_Platform_export({'Submissions':{'init':$author$project$Submissions$main(
